...
var alertError = sliceSquareAlerts.actions.alertError;
export function actionAlertError(dispatch, message) {
    dispatch(alertError(message));
}
var merchi = new Merchi();
var _a = sliceSquareForm.actions, actionSquarePaymentEnd = _a.actionSquarePaymentEnd, actionSquarePaymentStart = _a.actionSquarePaymentStart;
export function actionSquarePaymentProcess(dispatch, cart, sourceId, callbackPaymentSuccess) {
    return __awaiter(this, void 0, void 0, function () {
        var url, fetchOptions, r, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dispatch(actionSquarePaymentStart());
                    url = "/cart/".concat(cart.id, "/square/payment/");
                    fetchOptions = {
                        method: 'GET',
