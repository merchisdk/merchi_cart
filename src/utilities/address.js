...
export function makeAddress(addressJson, makeDirty) {
    ...
    return address.fromJson(addressJson, { makeDirty: makeDirty });
}
var isoCountries = {
    AF: "Afghanistan",
    AX: "Aland Islands",
...
export function addressInOneLine(address) {
    ...
    var city = a.city, country = a.country, lineOne = a.lineOne, lineTwo = a.lineTwo, postcode = a.postcode, state = a.state;
...
export function geoSuggestResultAsNewAddress(resp) {
    var addressComponents = resp && resp.gmaps ?
                ...
                switch (addrType) {
                    ...
                    case 'route':
                        ...
                        address.lineOne = oldLineOne.includes(addressVal) ?
                            oldLineOne : "".concat(oldLineOne, " ").concat(addressVal);
                        break;
                    case 'locality':
                    case 'sublocality':
