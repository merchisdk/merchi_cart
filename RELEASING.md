...
The cart build now emits TypeScript declarations into lib, and package.json points types to lib/index.d.ts. Package validation checks main, module, and types against the npm archive file list before publication.
